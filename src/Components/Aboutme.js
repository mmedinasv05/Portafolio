...
const SKILLS = ["HTML.", "CSS.", "Bootstrap.", "Javascript.", "React.", "Git."];
    ...
    <main className="about-container">
      ...
      <section className="about-description animate__animated animate__fadeInUp">
        <p className="paragraph">
          En 2019 descubrí mi pasión por el desarrollo web al crear mi primera
        ...
        <p className="paragraph">
          Aunque aún no cuento con experiencia profesional, he tratado de
